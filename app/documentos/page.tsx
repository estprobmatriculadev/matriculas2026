    ...
    <AppLayout userRole={userRole}>
      <div className="max-w-6xl mx-auto space-y-8 pb-20">
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          {/* FAQ IA Sidebar (Right - 1/3) */}
          <div className="lg:col-span-1">
            <div className="bg-primary text-on-primary rounded-[2.5rem] p-8 shadow-xl relative overflow-hidden flex flex-col h-[600px]">
              <div className="z-10 flex-1 flex flex-col h-full">
                <div className="flex flex-col items-center text-center mb-6">
                  <div className="w-12 h-12 bg-on-primary/20 rounded-2xl flex items-center justify-center mb-2">
                    <Bot size={24} />
                  </div>
                  <h3 className="font-bold text-lg">Assistente Clóvis</h3>
                  <p className="text-[10px] opacity-60 uppercase font-bold tracking-widest">Respostas Instantâneas</p>
                </div>

                <div className="flex-1 bg-white/10 rounded-2xl p-4 overflow-y-auto space-y-4 mb-4 scrollbar-hide">
                  {messages.map((m, i) => (
                    <div key={i} className={`flex ${m.role === "user" ? "justify-end" : "justify-start"}`}>
                      <div className={`p-4 rounded-2xl text-xs leading-relaxed max-w-[90%] text-center ${
                        m.role === "user" 
                  ...
                  {chatLoading && (
                    <div className="flex justify-center italic text-[10px] text-white/60 py-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder="Diga 'Oi'..."
                    className="w-full bg-white/10 border border-white/20 rounded-full py-3 pl-4 pr-12 text-sm text-white placeholder-white/40 focus:outline-none focus:bg-white/20 transition-all text-center"
                  />
                  <button 
        ...
        {showSupport && (
          <div className="fixed inset-0 bg-primary/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <form action={`mailto:est.probmatricula@escola.pr.gov.br`} method="GET" className="space-y-6 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-surface-container-low border border-surface-border rounded-2xl p-4 text-sm min-h-[120px] outline-none text-center"
                  />
                </div>
                <button 
                  type="submit"
                  className="w-full py-4 bg-primary text-on-primary font-bold rounded-full shadow-lg hover:scale-105 transition-all"
                >
